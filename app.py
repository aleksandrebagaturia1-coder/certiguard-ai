...
st.markdown("""
    <style>
        ...
        /* HIDE ALL FORM HINTS (Press Enter to submit) */
...
# API Key-ს ამოღება უსაფრთხოდ (არ ტეხავს პროგრამას ლოკალურად გაშვებისას)
try:
    OPENAI_API_KEY = st.secrets["OPENAI_API_KEY"]
except Exception:
    # ლოკალური ტესტირებისთვის, თუ secrets არ გვაქვს
    OPENAI_API_KEY = "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"
